    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-16">
          ...
          <p
            className={`text-[hsl(var(--charcoal))]/60 text-base max-w-2xl font-body font-light transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
              }`}
          >
            Our architectural work spans residential, commercial, and healthcare projects,
            each designed with careful consideration of context, climate, and client aspirations.
          </p>
        </div>
